  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="functions/javascript/functions_jquery_tablesorter.min.js"/>
        <script type="text/javascript" src="functions/javascript/functions_sitemap.js"/>
        <link href="functions/css/sitemap.css" type="text/css" rel="stylesheet"/>
      </head>
