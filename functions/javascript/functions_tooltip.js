...
*
* @package      iLance\Javascript\ToolTip
* @version	4.0.0.8059
* @author       Walter Zorn
*/
...
config. Width			= 383 		// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
...
config. BalloonImgPath		= IMAGEBASE + "v4/" // IMAGEBASE + "icons/" Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
// Sizes of balloon images
config. BalloonEdgeSize		= 8 //6		// Integer - sidelength of quadratic corner images
config. BalloonStemWidth	= 29 //15	// Integer
config. BalloonStemHeight	= 14 //19	// Integer
...
balloon.OnCreateContentString = function()
{
	...
	tt_sContent = '<table border="0" cellpadding="0" cellspacing="0" style="width:auto;padding:0px;margin:0px;left:0px;top:0px;"><tr>'
				...
				+ '<img id="bALlOOnT" style="position:relative;top:4px;z-index:1;display:none;' + sCssImg + '" src="' + aImg[9].src + '" width="' + tt_aV[BALLOONSTEMWIDTH] + '" height="' + tt_aV[BALLOONSTEMHEIGHT] + '" />'
				...
				+ '</td>'
				// Content
				+ '<td style="position:relative;line-height:1.4em;'
				...
				+ '<img id="bALlOOnB" style="position:relative;top:-4px;left:2px;z-index:1;display:none;' + sCssImg + '" src="' + aImg[10].src + '" width="' + tt_aV[BALLOONSTEMWIDTH] + '" height="' + tt_aV[BALLOONSTEMHEIGHT] + '" />'
				+ '</td>'
				// Right-bottom corner
				+ '<td valign="top"' + sCssCrn + '>'
